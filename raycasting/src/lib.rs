...
pub const     DARK_RED: RGB = RGB { r: 85, g: 0, b: 0 };
pub const   DARK_GREEN: RGB = RGB { r: 0, g: 85, b: 0 };
pub const    DARK_BLUE: RGB = RGB { r: 0, g: 0, b: 85 };
pub const    DARK_CYAN: RGB = RGB { r: 0, g: 85, b: 85 };
pub const DARK_MAGENTA: RGB = RGB { r: 85, g: 0, b: 85 };
pub const  DARK_YELLOW: RGB = RGB { r: 85, g: 85, b: 0 };

pub const     RED: RGB = RGB { r: 170, g: 0, b: 0 };
pub const   GREEN: RGB = RGB { r: 0, g: 170, b: 0 };
pub const    BLUE: RGB = RGB { r: 0, g: 0, b: 170 };
pub const    CYAN: RGB = RGB { r: 0, g: 170, b: 170 };
pub const MAGENTA: RGB = RGB { r: 170, g: 0, b: 170 };
pub const  YELLOW: RGB = RGB { r: 170, g: 170, b: 0 };
...
pub const BROWN: RGB = RGB { r: 64, g: 32, b: 0 };
